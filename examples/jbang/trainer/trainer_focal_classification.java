...
public class trainer_focal_classification {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("====================================================");
        System.out.println(" Gollek Focal Classification Trainer (JBang)");
        System.out.println("====================================================");
        ...
        float[] focalClassWeights = Gollek.DL.classWeightsFor(3, labels);
        ...
        TrainingSummary summary = Gollek.DL.fit(
                ...
                80,
                0.06f,
                Gollek.DL.TrainingPreset.CLASSIFICATION_FOCAL_ADAMW,
        ...
        var evaluation = Gollek.DL.evaluate(
                model,
                validation,
                Gollek.DL.focalLoss(2.0f, focalClassWeights)::compute,
                requestedDevice,
