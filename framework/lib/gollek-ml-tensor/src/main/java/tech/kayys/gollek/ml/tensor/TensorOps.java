 ...
 *
 * <p>
 * Provides PyTorch-like advanced indexing operations:
 * <ul>
 * <li>Slicing: {@link #slice(int, long, long)}, {@link #index(int, long)}</li>
 * <li>Stacking: {@link #cat(int, List)}, {@link #stack(int, List)}</li>
 * <li>Gathering: {@link #gather(int, Tensor)},
 * {@link #scatter(int, Tensor, Tensor)}</li>
 * <li>Boolean indexing: {@link #maskedSelect(Tensor)},
 * {@link #maskedFill(Tensor, float)}</li>
...
public final class TensorOps {
     ...
     *
     *                                   <p>
     *                                   Example: {@code tensor.slice(1, 5, 15)}
     *                                   selects indices 5 to 14 along dimension 1.
     */
     ...
     *
     *         <p>
     *         Selects elements using advanced boolean or integer indexing.
     */
     ...
     *
     *         <p>
     *         All tensors must have same shape except in dimension {@code dim}.
     ...
     *
     *         <p>
     *         Equivalent to PyTorch's gather operation.
     *         Example: {@code gather(1, x, idx)} where x.shape=(2,10) and
     *         idx.shape=(2,3)
     ...
     *
     *         <p>
     *         Example: {@code maskedSelect(x, x > 0)} selects positive elements.
     */
     ...
     *
     *         <p>
     *         Example: {@code maskedFill(x, x < 0, 0)} replaces negative values
     *         with 0.
     */
