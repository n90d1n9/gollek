...
The `gollek-ml-autograd` module is the core automatic differentiation (AD) engine for the Gollek ML framework. It provides reverse-mode AD allowing you to define complex computational graphs dynamically and compute gradients seamlessly.
