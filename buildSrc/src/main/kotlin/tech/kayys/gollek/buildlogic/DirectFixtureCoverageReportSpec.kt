...
object DirectFixtureCoverageReportSpec {
    ...
    val schemaId =
        "https://gollek.ai/schemas/build/model-family-direct-fixtures.v$schemaVersion.schema.json"

    const val moduleNamePattern = "^gollek-model-[a-z0-9-]+$"
    const val moduleNamePrefix = "gollek-model-"
