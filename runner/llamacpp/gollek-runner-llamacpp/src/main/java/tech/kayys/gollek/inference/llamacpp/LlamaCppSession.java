 ...
 * chat workloads.
 *
 * <p>Instances are created and pooled by {@link LlamaCppSessionManager}. Callers
...
public class LlamaCppSession {
    ...
    private static final Logger log = Logger.getLogger(LlamaCppSession.class);
     ...
     */
    public LlamaCppSession(String sessionId, String modelPath, LlamaCppBinding binding) {
