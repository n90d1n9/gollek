...
import tech.kayys.gollek.ml.Gollek.DL.SchedulerFactory;
...
final class GollekTrainingRequests {
    private GollekTrainingRequests() {
    }

    static GollekTrainingRuntime.Request fromOptions(
            NNModule model,
    ...
    static GollekTrainingRuntime.Request fromLegacy(
            NNModule model,
            Iterable<Batch> trainLoader,
            Iterable<Batch> validationLoader,
            int epochs,
    ...
    private static GollekTrainingRuntime.Request fromResolvedValues(
            NNModule model,
            Iterable<Batch> trainLoader,
            Iterable<Batch> validationLoader,
            int epochs,
        ...
        return new GollekTrainingRuntime.Request(
                model,
                trainLoader,
                validationLoader,
                epochs,
