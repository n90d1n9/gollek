...
public class ModelConfig {
    ...
    private String ropeTypeFull;
    private String ropeTypeSliding;
    ...
    public String getRopeTypeFull() {
        return ropeTypeFull;
    }

    public void setRopeTypeFull(String ropeTypeFull) {
        this.ropeTypeFull = ropeTypeFull;
    }

    public String getRopeTypeSliding() {
        return ropeTypeSliding;
    }

    public void setRopeTypeSliding(String ropeTypeSliding) {
        this.ropeTypeSliding = ropeTypeSliding;
    }
    ...
    public boolean isGemma4PackedMoe() {
        ...
        return gemma4
                && (enableMoeBlock()
                        || (getMoeIntermediateSize() != null && getMoeIntermediateSize() > 0)
                        || ((getNumLocalExperts() != null && getNumLocalExperts() > 1) && (getNumExpertsPerTok() != null && getNumExpertsPerTok() > 0)));
    }
    ...
    public String ropeTypeForLayer(int layerIdx) {
        String type = getLayerType(layerIdx);
        if ("full_attention".equals(type) && ropeTypeFull != null) {
            return ropeTypeFull;
        }
        if ("sliding_attention".equals(type) && ropeTypeSliding != null) {
            return ropeTypeSliding;
        }
        return ropeScaling != null ? ropeScaling.type : "default";
    }
