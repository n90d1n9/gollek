package tech.kayys.gollek.examples;
...
public class MNISTCNNExample {
    ...
    static class MNISTNet extends NNModule {
        ...
        public MNISTNet() {
            ...
            this.conv1 = new Conv2d(1, 32, new long[]{3, 3}, 1, 1);
            this.bn1 = new BatchNorm2d(32);
            this.pool1 = new MaxPool2d(new long[]{2, 2}, 2);

            // Second conv: 32 -> 64 channels
            this.conv2 = new Conv2d(32, 64, new long[]{3, 3}, 1, 1);
            this.bn2 = new BatchNorm2d(64);
            this.pool2 = new MaxPool2d(new long[]{2, 2}, 2);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Adam optimizer = new Adam(model.parameters(), config.learningRate, 0.9f, 0.999f, 1e-8f);
        CosineAnnealingLR scheduler = new CosineAnnealingLR(optimizer, config.numEpochs);
    ...
    static class MNISTDataset extends Dataset {
